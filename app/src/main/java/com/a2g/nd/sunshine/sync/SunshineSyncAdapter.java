package com.a2g.nd.sunshine.sync;
...
import com.a2g.nd.sunshine.BuildConfig;
import com.a2g.nd.sunshine.MainActivity;
import com.a2g.nd.sunshine.R;
import com.a2g.nd.sunshine.Utility;
import com.a2g.nd.sunshine.data.WeatherContract;
import com.a2g.nd.sunshine.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED = "com.a2g.nd.sunshine.ACTION_DATA_UPDATED";
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            //insert it using the content resolver and the base URI
